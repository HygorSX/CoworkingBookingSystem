...
public sealed class CreateReservationHandlerTests
{
    ...
    public void Setup()
    {
        ...
        _validCommand = new CreateReservation(userToCreateReservation.Id, roomToCreateReservation.Id, DateTime.Now.AddHours(3), DateTime.Now.AddHours(6), EReservationStatus.Pending);
    }
    ...
    {
        var command = new CreateReservation(Guid.NewGuid(), Guid.NewGuid(), DateTime.Now.AddHours(3), DateTime.Now.AddHours(6), EReservationStatus.Pending);
    ...
    public void Given_a_valid_command_but_nonexistent_room_it_should_fail()
    {
        ...
        var command = new CreateReservation(user.Id, Guid.NewGuid(), DateTime.Now.AddHours(3), DateTime.Now.AddHours(6), EReservationStatus.Pending);
        var result = (GenericCommandResult)_reservationHandler.Handle(command);
    ...
    public void Given_a_valid_command_but_conflicting_reservation_it_should_fail()
    {
        ...
        var command = new CreateReservation(user.Id, room.Id, DateTime.Now.AddHours(3), DateTime.Now.AddHours(6), EReservationStatus.Pending);
        var result = (GenericCommandResult)_reservationHandler.Handle(command);
